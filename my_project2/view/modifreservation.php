...
$res=$reservationCtr->getreservations($_GET['id']);
...
<div class="c">
<form action="modifreservation_action.php" method="post">
    <label for="username">id reservation:</label>
    <input type="text" id="username" name="idr"  value = "<?php echo $res['ReservationID'] ?>"required>

    <label for="username">id client :</label>
    <input type="text" id="username" name="idc"  value = "<?php echo $res['ClientID'] ?>"required>

    <label for="username"> id destination:</label>
    <input type="text" id="username" name="iddes" value = "<?php echo $res['iddes'] ?>" required>

    <label for="password">Date Reservation:</label>
    <input type="date" id="adr" name="date"value = "<?php echo $res['DateReservation'] ?>" required>
