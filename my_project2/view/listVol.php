...
<a href='ajoutVol.php'  class="r">Inscription</a>
</div>
<style>
    ...
    <?php
        ...
        foreach ($rese as $row) {
            ...
            <tr>
                ...
                <td><a href='modifVol.php?id=$row[idvol]'>Modifier</a></td>
                <td><a href='supVol.php?id=$row[idvol]'>Supprimer</a></td>
            </tr>";
        }
...
<script>
    ...
    document.getElementById('searchBar').addEventListener('input', function () {
        ...
        for (i = 0; i < tr.length; i++) {
            td = tr[i].getElementsByTagName('td')[0]; // Colonne du nom
            if (td) {
