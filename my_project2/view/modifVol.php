...
<div class="navbar">
    ...
    <a    href="listVol.php" class="active"  >Vol</a>
...
<div class="c">
<form action="modifVol_action.php" method="post">
    <label for="username">Id vol:</label>
    <input type="text" id="username" name="idvol" value = "<?php echo $res['idvol'] ?>"  readonly>
